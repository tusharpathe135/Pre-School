                                ...
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control border-0" id="fathername"
                                                name="fathername" placeholder="Father Name" required>
                                            <label for="gname">Father Name</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control border-0" id="mothername"
                                                name="mothername" placeholder="Mother Name" required>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control border-0" id="parentmobno"
                                                name="parentmobno" placeholder="Parents Mobile No." required>
                                            <label for="gname">Parents Mobile No.</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-floating">
                                            <input type="email" class="form-control border-0" id="parentemail"
                                                name="parentemail" placeholder="Parents Email" required>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-floating">
                                            <select class="form-control" id="erollprogram" name="erollprogram" required>
                                                ...
                                                <option value="PlayGroup-1.8 to 3 years">PlayGroup-1.8 to 3 years
                                                </option>
                                                <option value="Nursery-2.5 to 4 years">Nursery-2.5 to 4 years</option>
                                                <option value="Junior KG- 3.5 to 5 years">Junior KG-3.5 to 5 years
                                                </option>
                                                <option value="Senior KG- 4.5 to 6 years">Senior KG- 4.5 to 6 years
                                                </option>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control border-0" placeholder="Leave a message here"
                                                id="message" style="height: 100px" name="message" required></textarea>
