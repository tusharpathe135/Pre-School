                        ...
                        <div class="classes-item">
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle"
                                    src="admin/classpic/<?php echo $result['feacturePic'] ?>"
                                    alt="<?php echo $result['className'] ?>">
                            </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center">
                                        <img class="rounded-circle flex-shrink-0"
                                            src="admin/teacherspic/<?php echo $result['teacherPic'] ?>" alt=""
                        ...
                        <div class="h-100 d-flex flex-column justify-content-center p-5">
                            ...
                            <form method="post">
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-floating">
                                            <input type="email" class="form-control border-0" id="emailid"
                                                name="emailid" placeholder="Gurdian Email" required>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item position-relative">
                            <img class="img-fluid rounded-circle w-75"
                                src="admin/teacherspic/<?php echo $row['teacherPic'] ?>" alt="">
                            <div class="team-text">
