        ...
        <div class="row g-5">
            ...
            while ($data = mysqli_fetch_array($sql)) {
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Pundaliknagar, Chh.Sambhajinagar</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>9021808151</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>tusharpathe135@gmail.com</p>
